...
ADMIN_STRINGS = {
    ...
    'blog.ai_generate': {'en': 'Generate with AI', 'es': 'Generar con IA'},
    'blog.ai_generating': {'en': 'Generating…', 'es': 'Generando…'},
    'blog.ai_hint': {'en': 'Uses the title and uploaded Markdown to suggest an excerpt and tags.', 'es': 'Usa el título y el Markdown subido para sugerir un extracto y etiquetas.'},
    'blog.ai_hint_es': {'en': 'Uses the Spanish title/Markdown (or the English ones, if missing) to suggest a Spanish excerpt.', 'es': 'Usa el título/Markdown en español (o el inglés, si falta) para sugerir un extracto en español.'},
    ...
    'flash.ai_not_configured': {'en': 'AI suggestions are not configured — set GEMINI_API_KEY to enable this feature.', 'es': 'Las sugerencias de IA no están configuradas — define GEMINI_API_KEY para activar esta función.'},
    'flash.ai_title_required': {'en': 'Add a title first.', 'es': 'Añade primero un título.'},
